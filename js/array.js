...
const courses = ["HTML", "CSS", "JS", "React", "Node"];
// const person = [ "Frank", 30, true, null, undefined, { name: "Obed" }, [1, 2, 3] ];

// Accessing value in an array using index
console.log(courses[0])
...
const roles = ['user', 'client', 'vendor', 'admin', 'superadmin']

// let authUser = {
//   name: "Faloe Ultimate",
//   email: "ultimafaloe@outlook.com",
//   role: "supplier"
// } 

const isUserAdmin = roles.includes('admin')

console.log("Check is user is an admin: ", isUserAdmin)




const cars = ['camry', 'ferrari', 'tesla', 'mercedes', 'bmw']

const availableInstock = cars.includes('bmw')



console.log("CHecking if we have BMW in stock: ", availableInstock)
...
const neededNumbers = nums.slice(0, 3)
console.log(neededNumbers)

const carsToString = cars.join('$ ')
console.log(cars)
